...
def _задушен_ютубом(err):
    ...
    return bool(re.search(
        ...
        r"HTTP Error 403|did not get any data|read, retry|reset by peer|"
...
КОММЕНТАРИИ_МОДЕЛИ = (
    # Заказ автор 2026-09-14: «у модели чисто техническая задача — составлять
...
# Замена делается СКРИПТОМ, без модели (заказ автор 2026-09-15:
