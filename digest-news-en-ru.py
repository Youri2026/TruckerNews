...
def _только_новое(рассказ, релевантные):
    ...
    try:
        ответ = _chat(
            ...
            "словом: ПРОПУСК. Если новое есть — перескажи связно ТОЛЬКО "
            "новое и обновившееся, не повторяя уже сказанного, начни прямо "
            "с сути. При сомнении лучше покажи обновление, чем задави. "
