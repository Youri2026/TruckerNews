...
сборки**; список **ютуб-каналов** — включить/выключить, удалить, задать
«брать последних N»; и все **источники** — текстовые ленты, RSS-ленты
сайтов и телеграм-каналы, каждый можно добавить, убрать или отключить.
