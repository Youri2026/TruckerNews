...
<p align="center">
  <img src="pult-1-schedule.jpg" width="19%" alt="Расписание и ход выпуска">
  <img src="pult-2-channels.jpg" width="19%" alt="Ютуб-каналы">
  <img src="pult-2b-channels.jpg" width="19%" alt="Ютуб-каналы и добавление">
  <img src="pult-3-feeds.jpg" width="19%" alt="Текстовые и RSS ленты">
  <img src="pult-4-telegram.jpg" width="19%" alt="Телеграм-каналы">
</p>

Экскурсия по пульту сверху вниз: **расписание выпусков** (дни и часы) и
монитор **хода сборки**; **ютуб-каналы** — включить/выключить, удалить,
задать «брать последних N»; форма **добавления** канала; **текстовые и
RSS-ленты** сайтов; **телеграм-каналы** и кнопка **«Собрать выпуск
сейчас»**. Любой источник добавляется, убирается или отключается одним
касанием. *(Картинки кликабельны — открываются крупно.)*
